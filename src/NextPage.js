...
const NextPage=()=>{
    return(
        ...
        <div style={{'position':'relative','top':'-60px'}} class="row justify-content-between">  
            <p style={{'position':'absolute','display':'flex','top':'40px','border':'2px solid black','width':'230px','borderRadius':'20px 0 20px 0','textAlign':'center'}}>CO-CURRICULAR ACTIVITIES </p>
